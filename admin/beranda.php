          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total Poin <span>| Today</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                        $querysum = "select sum(jml_poin) as total_poin from poin";
                        $datasum = mysqli_query($koneksi,$querysum);
                        $resultsum = mysqli_fetch_array($datasum);
                      ?>
                      <h6><?php echo $resultsum['total_poin']?></h6>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total User <span>| Today</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <?php
                        $querycount = "select count(nis) as jml_data_user from user";
                        $datacount = mysqli_query($koneksi,$querycount);
                        $resultcount = mysqli_fetch_array($datacount);
                      ?>
                      <h6><?php echo $resultcount['jml_data_user']?></h6>
                    </div>
                  </div>
