    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="data_poin.php" class="active">
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $query = mysqli_query($koneksi, "select a.nama, b.jml_poin,b.id_poin,b.nis from user a, poin b where a.nis=b.nis");
                    while ($data = mysqli_fetch_array($query)) {  
                  ?>
                  <tr>
                    <th scope="row"><?php echo $no++?></th>
                    <td><?php echo $data['nama']?></td>
                    <td><?php echo $data['jml_poin']?></td>
                    <td>
                     

                       <!-- Basic Modal -->
              <button type="button" class="btn btn-warning mb-3" data-bs-toggle="modal" data-bs-target="#basicModal2<?php echo $data['id_poin'];?>">
                Edit
              </button>
              <div class="modal fade" id="basicModal2<?php echo $data['id_poin'];?>" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="proses_edit_poin.php" method="POST">
                    <div class="modal-body">
                      ...
                      <input type="text" name="poin" class="form-control mb-2" id="yourPoin" value="<?php echo $data['jml_poin'];?>" required>
